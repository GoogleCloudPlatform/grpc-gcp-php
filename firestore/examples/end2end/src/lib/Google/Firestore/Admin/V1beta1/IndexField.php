 ...
 * A field of an index.
 *
 * Generated from protobuf message <code>google.firestore.admin.v1beta1.IndexField</code>
 */
class IndexField extends \Google\Protobuf\Internal\Message
{
     ...
     * The field's mode.
     *
     * Generated from protobuf field <code>.google.firestore.admin.v1beta1.IndexField.Mode mode = 2;</code>
     */
    private $mode = 0;
    ...
    {
        GPBUtil::checkEnum($var, \Google\Firestore\Admin\V1beta1\IndexField_Mode::class);
        $this->mode = $var;
