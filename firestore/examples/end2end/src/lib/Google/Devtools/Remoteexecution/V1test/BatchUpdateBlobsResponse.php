...
class BatchUpdateBlobsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.devtools.remoteexecution.v1test.BatchUpdateBlobsResponse.Response responses = 1;</code>
     * @param \Google\Devtools\Remoteexecution\V1test\BatchUpdateBlobsResponse_Response[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResponses($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Devtools\Remoteexecution\V1test\BatchUpdateBlobsResponse_Response::class);
        $this->responses = $arr;
