...
class FaceAnnotation extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.vision.v1p1beta1.FaceAnnotation.Landmark landmarks = 3;</code>
     * @param \Google\Cloud\Vision\V1p1beta1\FaceAnnotation_Landmark[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setLandmarks($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Vision\V1p1beta1\FaceAnnotation_Landmark::class);
        $this->landmarks = $arr;
