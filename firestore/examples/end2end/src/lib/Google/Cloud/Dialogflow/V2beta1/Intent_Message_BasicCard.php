...
class Intent_Message_BasicCard extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.Intent.Message.BasicCard.Button buttons = 5;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\Intent_Message_BasicCard_Button[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setButtons($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\V2beta1\Intent_Message_BasicCard_Button::class);
        $this->buttons = $arr;
