 ...
 *
 * Generated from protobuf message <code>google.container.v1alpha1.Operation</code>
 */
class Operation extends \Google\Protobuf\Internal\Message
{
     ...
     * The operation type.
     *
     * Generated from protobuf field <code>.google.container.v1alpha1.Operation.Type operation_type = 3;</code>
     */
    private $operation_type = 0;
    /**
     * The current status of the operation.
     *
     * Generated from protobuf field <code>.google.container.v1alpha1.Operation.Status status = 4;</code>
     */
    private $status = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Container\V1alpha1\Operation_Type::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Container\V1alpha1\Operation_Status::class);
        $this->status = $var;
