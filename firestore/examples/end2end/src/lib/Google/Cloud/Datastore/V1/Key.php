...
class Key extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.datastore.v1.Key.PathElement path = 2;</code>
     * @param \Google\Cloud\Datastore\V1\Key_PathElement[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPath($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Datastore\V1\Key_PathElement::class);
        $this->path = $arr;
