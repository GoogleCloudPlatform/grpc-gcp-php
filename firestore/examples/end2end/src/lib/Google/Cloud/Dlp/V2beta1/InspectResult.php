 ...
 *
 * Generated from protobuf message <code>google.privacy.dlp.v2beta1.InspectResult</code>
 */
class InspectResult extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.privacy.dlp.v2beta1.Finding findings = 1;</code>
     * @param \Google\Cloud\Dlp\V2beta1\Finding[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setFindings($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dlp\V2beta1\Finding::class);
        $this->findings = $arr;
