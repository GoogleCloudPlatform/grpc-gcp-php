 ...
 *
 * Generated from protobuf message <code>google.privacy.dlp.v2beta2.TimePartConfig</code>
 */
class TimePartConfig extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.google.privacy.dlp.v2beta2.TimePartConfig.TimePart part_to_extract = 1;</code>
     */
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Dlp\V2beta2\TimePartConfig_TimePart::class);
