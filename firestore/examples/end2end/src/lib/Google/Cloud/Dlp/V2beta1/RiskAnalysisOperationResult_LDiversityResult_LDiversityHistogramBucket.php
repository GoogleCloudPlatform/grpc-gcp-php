...
class RiskAnalysisOperationResult_LDiversityResult_LDiversityHistogramBucket extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.privacy.dlp.v2beta1.RiskAnalysisOperationResult.LDiversityResult.LDiversityEquivalenceClass bucket_values = 4;</code>
     * @param \Google\Cloud\Dlp\V2beta1\RiskAnalysisOperationResult_LDiversityResult_LDiversityEquivalenceClass[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setBucketValues($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dlp\V2beta1\RiskAnalysisOperationResult_LDiversityResult_LDiversityEquivalenceClass::class);
