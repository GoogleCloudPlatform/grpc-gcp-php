...
class Key extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.privacy.dlp.v2beta1.Key.PathElement path = 2;</code>
     * @param \Google\Cloud\Dlp\V2beta1\Key_PathElement[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setPath($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dlp\V2beta1\Key_PathElement::class);
        $this->path = $arr;
