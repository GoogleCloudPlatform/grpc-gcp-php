 ...
 * and other utilities.
 */
class ConformanceServiceClient extends \Grpc\BaseStub {
    ...
    public function Parse(\Google\Api\Expr\V1alpha1\ParseRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.api.expr.v1alpha1.ConformanceService/Parse',
        $argument,
    ...
    public function Check(\Google\Api\Expr\V1alpha1\CheckRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.api.expr.v1alpha1.ConformanceService/Check',
        $argument,
    ...
    public function Eval(\Google\Api\Expr\V1alpha1\EvalRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.api.expr.v1alpha1.ConformanceService/Eval',
        $argument,
