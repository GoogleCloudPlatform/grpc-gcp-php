 ...
 */
class ClinicalCondition extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *           A set of names for the condition.
     *     @type \Google\Genomics\V1\ExternalId[]|\Google\Protobuf\Internal\RepeatedField $external_ids
     *           The set of external IDs for this condition.
...
class_alias(ClinicalCondition::class, \Google\Genomics\V1\VariantAnnotation_ClinicalCondition::class);
