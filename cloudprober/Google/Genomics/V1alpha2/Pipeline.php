...
class Pipeline extends \Google\Protobuf\Internal\Message
{
     ...
     *           User-specified description.
     *     @type \Google\Genomics\V1alpha2\PipelineParameter[]|\Google\Protobuf\Internal\RepeatedField $input_parameters
     *           Input parameters of the pipeline.
     *     @type \Google\Genomics\V1alpha2\PipelineParameter[]|\Google\Protobuf\Internal\RepeatedField $output_parameters
     *           Output parameters of the pipeline.
     *     @type \Google\Genomics\V1alpha2\DockerExecutor $docker
