 ...
 *
 * Generated from protobuf message <code>google.bigtable.v1.Mutation.DeleteFromFamily</code>
 */
...
class_alias(DeleteFromFamily::class, \Google\Bigtable\V1\Mutation_DeleteFromFamily::class);
