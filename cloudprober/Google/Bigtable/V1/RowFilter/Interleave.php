 ...
 *
 * Generated from protobuf message <code>google.bigtable.v1.RowFilter.Interleave</code>
 */
class Interleave extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Bigtable\V1\RowFilter[]|\Google\Protobuf\Internal\RepeatedField $filters
     *           The elements of "filters" all process a copy of the input row, and the
     *           results are pooled, sorted, and combined into a single output row.
     *           If multiple cells are produced with the same column and timestamp,
     *           they will all appear in the output row in an unspecified mutual order.
...
class_alias(Interleave::class, \Google\Bigtable\V1\RowFilter_Interleave::class);
