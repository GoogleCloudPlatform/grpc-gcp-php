...
namespace Google\Firestore\Admin\V1beta2\Field;
 ...
 *
 * Generated from protobuf message <code>google.firestore.admin.v1beta2.Field.IndexConfig</code>
 */
class IndexConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.firestore.admin.v1beta2.Index indexes = 1;</code>
     */
    private $indexes;
    /**
     * Output only.
     ...
     *
     *     @type \Google\Firestore\Admin\V1beta2\Index[]|\Google\Protobuf\Internal\RepeatedField $indexes
     *           The indexes supported for this field.
    ...
    public function __construct($data = NULL) {
        \GPBMetadata\Google\Firestore\Admin\V1Beta2\Field::initOnce();
     ...
     *
     * Generated from protobuf field <code>repeated .google.firestore.admin.v1beta2.Index indexes = 1;</code>
     * @param \Google\Firestore\Admin\V1beta2\Index[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setIndexes($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Firestore\Admin\V1beta2\Index::class);
        $this->indexes = $arr;
...
class_alias(IndexConfig::class, \Google\Firestore\Admin\V1beta2\Field_IndexConfig::class);
