...
namespace Google\Firestore\Admin\V1beta1\Index;
 ...
 *
 * Protobuf type <code>google.firestore.admin.v1beta1.Index.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Firestore\Admin\V1beta1\Index_State::class);
