...
class FirestoreAdminClient extends \Grpc\BaseStub {
     ...
     * Cloud Storage.
     * @param \Google\Firestore\Admin\V1beta1\ExportDocumentsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function ExportDocuments(\Google\Firestore\Admin\V1beta1\ExportDocumentsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.firestore.admin.v1beta1.FirestoreAdmin/ExportDocuments',
        $argument,
        ['\Google\LongRunning\Operation', 'decode'],
        $metadata, $options);
    }
     ...
     * @param \Google\Firestore\Admin\V1beta1\ImportDocumentsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     */
    public function ImportDocuments(\Google\Firestore\Admin\V1beta1\ImportDocumentsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.firestore.admin.v1beta1.FirestoreAdmin/ImportDocuments',
        $argument,
        ['\Google\LongRunning\Operation', 'decode'],
        $metadata, $options);
    }
