...
class Command extends \Google\Protobuf\Internal\Message
{
     ...
     *           evaluated with respect to the input root, or an absolute path.
     *           The working directory will always be the input root.
     *     @type \Google\Devtools\Remoteexecution\V1test\Command\EnvironmentVariable[]|\Google\Protobuf\Internal\RepeatedField $environment_variables
     *           The environment variables to set when running the program. The worker may
     *           provide its own default environment variables; these defaults can be
     *           overridden using this field. Additional variables can also be specified.
     *           In order to ensure that equivalent `Command`s always hash to the same
     ...
     *
     * Generated from protobuf field <code>repeated .google.devtools.remoteexecution.v1test.Command.EnvironmentVariable environment_variables = 2;</code>
     * @param \Google\Devtools\Remoteexecution\V1test\Command\EnvironmentVariable[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEnvironmentVariables($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Devtools\Remoteexecution\V1test\Command\EnvironmentVariable::class);
