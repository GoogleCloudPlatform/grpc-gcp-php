...
class Platform extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Devtools\Remoteexecution\V1test\Platform\Property[]|\Google\Protobuf\Internal\RepeatedField $properties
     *           The properties that make up this platform. In order to ensure that
     *           equivalent `Platform`s always hash to the same value, the properties MUST
     *           be lexicographically sorted by name, and then by value. Sorting of strings
     *           is done by code point, equivalently, by the UTF-8 bytes.
     ...
     *
     * Generated from protobuf field <code>repeated .google.devtools.remoteexecution.v1test.Platform.Property properties = 1;</code>
     * @param \Google\Devtools\Remoteexecution\V1test\Platform\Property[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setProperties($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Devtools\Remoteexecution\V1test\Platform\Property::class);
        $this->properties = $arr;
