...
class Artifacts extends \Google\Protobuf\Internal\Message
{
     ...
     *           results field.
     *           If any of the images fail to be pushed, the build is marked FAILURE.
     *     @type \Google\Devtools\Cloudbuild\V1\Artifacts\ArtifactObjects $objects
     *           A list of objects to be uploaded to Cloud Storage upon successful
     *           completion of all build steps.
     *           Files in the workspace matching specified paths globs will be uploaded to
     *           the specified Cloud Storage location using the builder service account's
     ...
     *
     * Generated from protobuf field <code>.google.devtools.cloudbuild.v1.Artifacts.ArtifactObjects objects = 2;</code>
     * @return \Google\Devtools\Cloudbuild\V1\Artifacts\ArtifactObjects
     */
     ...
     *
     * Generated from protobuf field <code>.google.devtools.cloudbuild.v1.Artifacts.ArtifactObjects objects = 2;</code>
     * @param \Google\Devtools\Cloudbuild\V1\Artifacts\ArtifactObjects $var
     * @return $this
     */
