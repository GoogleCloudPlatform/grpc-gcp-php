...
class BuildOptions extends \Google\Protobuf\Internal\Message
{
     ...
     *           build's `Secret`. These variables will be available to all build steps
     *           in this build.
     *     @type \Google\Devtools\Cloudbuild\V1\Volume[]|\Google\Protobuf\Internal\RepeatedField $volumes
     *           Global list of volumes to mount for ALL build steps
     *           Each volume is created as an empty volume prior to starting the build
     *           process. Upon completion of the build, volumes and their contents are
     *           discarded. Global volume names and paths cannot conflict with the volumes
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Devtools\Cloudbuild\V1\Hash\HashType::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Devtools\Cloudbuild\V1\BuildOptions_LoggingMode::class);
        $this->logging = $var;
