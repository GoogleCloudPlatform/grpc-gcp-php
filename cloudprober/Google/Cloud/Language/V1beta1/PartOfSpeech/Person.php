 ...
 *
 * Protobuf type <code>google.cloud.language.v1beta1.PartOfSpeech.Person</code>
 */
class Person
{
    /**
...
class_alias(Person::class, \Google\Cloud\Language\V1beta1\PartOfSpeech_Person::class);
