 ...
 *
 * Protobuf type <code>google.cloud.language.v1beta1.PartOfSpeech.Voice</code>
 */
class Voice
{
    /**
...
class_alias(Voice::class, \Google\Cloud\Language\V1beta1\PartOfSpeech_Voice::class);
