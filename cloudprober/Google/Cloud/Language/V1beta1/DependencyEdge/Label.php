...
namespace Google\Cloud\Language\V1beta1\DependencyEdge;

/**
 * The parse label enum for the token.
 *
 * Protobuf type <code>google.cloud.language.v1beta1.DependencyEdge.Label</code>
 */
class Label
{
    /**
...
class_alias(Label::class, \Google\Cloud\Language\V1beta1\DependencyEdge_Label::class);
