...
class VideoAnnotationResults extends \Google\Protobuf\Internal\Message
{
     ...
     *           Video file location in
     *           [Google Cloud Storage](https://cloud.google.com/storage/).
     *     @type \Google\Cloud\VideoIntelligence\V1beta1\LabelAnnotation[]|\Google\Protobuf\Internal\RepeatedField $label_annotations
     *           Label annotations. There is exactly one element for each unique label.
     *     @type \Google\Cloud\VideoIntelligence\V1beta1\FaceAnnotation[]|\Google\Protobuf\Internal\RepeatedField $face_annotations
     *           Face annotations. There is exactly one element for each unique face.
     *     @type \Google\Cloud\VideoIntelligence\V1beta1\VideoSegment[]|\Google\Protobuf\Internal\RepeatedField $shot_annotations
     *           Shot annotations. Each shot is represented as a video segment.
     *     @type \Google\Cloud\VideoIntelligence\V1beta1\SafeSearchAnnotation[]|\Google\Protobuf\Internal\RepeatedField $safe_search_annotations
     *           Safe search annotations.
