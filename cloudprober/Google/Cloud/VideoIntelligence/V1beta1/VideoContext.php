...
class VideoContext extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\VideoIntelligence\V1beta1\VideoSegment[]|\Google\Protobuf\Internal\RepeatedField $segments
     *           Video segments to annotate. The segments may overlap and are not required
     *           to be contiguous or span the whole video. If unspecified, each video
     *           is treated as a single segment.
     ...
     *           Whether the video has been shot from a stationary (i.e. non-moving) camera.
     *           When set to true, might improve detection accuracy for moving objects.
     *     @type string $label_detection_model
     *           Model to use for label detection.
     *           Supported values: "latest" and "stable" (the default).
     *     @type string $face_detection_model
     *           Model to use for face detection.
     *           Supported values: "latest" and "stable" (the default).
     *     @type string $shot_change_detection_model
     *           Model to use for shot change detection.
     *           Supported values: "latest" and "stable" (the default).
     *     @type string $safe_search_detection_model
     *           Model to use for safe search detection.
     *           Supported values: "latest" and "stable" (the default).
     * }
     */
