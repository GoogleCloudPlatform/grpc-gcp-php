...
class Job extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type string $job_id
     *           Required. The user-specified id of the job.
     *     @type \Google\Cloud\Ml\V1\TrainingInput $training_input
     *           Input parameters to create a training job.
     *     @type \Google\Cloud\Ml\V1\PredictionInput $prediction_input
     ...
     *           Output only. The details of a failure or a cancellation.
     *     @type \Google\Cloud\Ml\V1\TrainingOutput $training_output
     *           The current training job result.
     *     @type \Google\Cloud\Ml\V1\PredictionOutput $prediction_output
