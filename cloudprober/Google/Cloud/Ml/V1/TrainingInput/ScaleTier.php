...
namespace Google\Cloud\Ml\V1\TrainingInput;
 ...
 *
 * Protobuf type <code>google.cloud.ml.v1.TrainingInput.ScaleTier</code>
 */
class ScaleTier
{
    /**
...
class_alias(ScaleTier::class, \Google\Cloud\Ml\V1\TrainingInput_ScaleTier::class);
