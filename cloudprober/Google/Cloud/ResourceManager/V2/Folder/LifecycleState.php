...
namespace Google\Cloud\ResourceManager\V2\Folder;

/**
 * Folder lifecycle states.
 *
 * Protobuf type <code>google.cloud.resourcemanager.v2.Folder.LifecycleState</code>
 */
...
class_alias(LifecycleState::class, \Google\Cloud\ResourceManager\V2\Folder_LifecycleState::class);
