...
class SimpleResponses extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Dialogflow\V2beta1\Intent\Message\SimpleResponse[]|\Google\Protobuf\Internal\RepeatedField $simple_responses
     *           Required. The list of simple responses.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.dialogflow.v2beta1.Intent.Message.SimpleResponse simple_responses = 1;</code>
     * @param \Google\Cloud\Dialogflow\V2beta1\Intent\Message\SimpleResponse[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setSimpleResponses($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Dialogflow\V2beta1\Intent\Message\SimpleResponse::class);
...
class_alias(SimpleResponses::class, \Google\Cloud\Dialogflow\V2beta1\Intent_Message_SimpleResponses::class);
