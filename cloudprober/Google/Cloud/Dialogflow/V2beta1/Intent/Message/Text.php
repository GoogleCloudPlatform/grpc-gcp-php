 ...
 *
 * Generated from protobuf message <code>google.cloud.dialogflow.v2beta1.Intent.Message.Text</code>
 */
...
class_alias(Text::class, \Google\Cloud\Dialogflow\V2beta1\Intent_Message_Text::class);
