...
namespace Google\Cloud\Datastore\V1beta3\CommitRequest;

/**
 * The modes available for commits.
 *
 * Protobuf type <code>google.datastore.v1beta3.CommitRequest.Mode</code>
 */
class Mode
{
    /**
...
class_alias(Mode::class, \Google\Cloud\Datastore\V1beta3\CommitRequest_Mode::class);
