...
namespace Google\Cloud\Datastore\V1beta3\PropertyOrder;

/**
 * The sort direction.
 *
 * Protobuf type <code>google.datastore.v1beta3.PropertyOrder.Direction</code>
 */
class Direction
{
    /**
...
class_alias(Direction::class, \Google\Cloud\Datastore\V1beta3\PropertyOrder_Direction::class);
