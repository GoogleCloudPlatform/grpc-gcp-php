...
namespace Google\Cloud\Datastore\V1beta3\PropertyFilter;

/**
 * A property filter operator.
 *
 * Protobuf type <code>google.datastore.v1beta3.PropertyFilter.Operator</code>
 */
class Operator
{
    /**
...
class_alias(Operator::class, \Google\Cloud\Datastore\V1beta3\PropertyFilter_Operator::class);
