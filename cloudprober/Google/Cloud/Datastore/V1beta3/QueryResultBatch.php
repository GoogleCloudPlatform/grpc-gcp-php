 ...
 *
 * Generated from protobuf message <code>google.datastore.v1beta3.QueryResultBatch</code>
 */
class QueryResultBatch extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.datastore.v1beta3.EntityResult.ResultType entity_result_type = 1;</code>
     */
    private $entity_result_type = 0;
    /**
     * The results for this batch.
     *
     * Generated from protobuf field <code>repeated .google.datastore.v1beta3.EntityResult entity_results = 2;</code>
     */
     ...
     *
     * Generated from protobuf field <code>.google.datastore.v1beta3.QueryResultBatch.MoreResultsType more_results = 5;</code>
     */
     ...
     *           The result type for every entity in `entity_results`.
     *     @type \Google\Cloud\Datastore\V1beta3\EntityResult[]|\Google\Protobuf\Internal\RepeatedField $entity_results
     *           The results for this batch.
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Datastore\V1beta3\EntityResult_ResultType::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.datastore.v1beta3.EntityResult entity_results = 2;</code>
     * @param \Google\Cloud\Datastore\V1beta3\EntityResult[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEntityResults($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Datastore\V1beta3\EntityResult::class);
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Datastore\V1beta3\QueryResultBatch_MoreResultsType::class);
