...
namespace Google\Cloud\Datastore\V1beta3\QueryResultBatch;

/**
 * The possible values for the `more_results` field.
 *
 * Protobuf type <code>google.datastore.v1beta3.QueryResultBatch.MoreResultsType</code>
 */
...
class_alias(MoreResultsType::class, \Google\Cloud\Datastore\V1beta3\QueryResultBatch_MoreResultsType::class);
