...
namespace Google\Cloud\Datastore\V1beta3\Key;
 ...
 *
 * Generated from protobuf message <code>google.datastore.v1beta3.Key.PathElement</code>
 */
...
class_alias(PathElement::class, \Google\Cloud\Datastore\V1beta3\Key_PathElement::class);
