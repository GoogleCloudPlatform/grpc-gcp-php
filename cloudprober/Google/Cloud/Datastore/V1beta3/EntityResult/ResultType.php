...
namespace Google\Cloud\Datastore\V1beta3\EntityResult;
 ...
 *
 * Protobuf type <code>google.datastore.v1beta3.EntityResult.ResultType</code>
 */
class ResultType
{
    /**
...
class_alias(ResultType::class, \Google\Cloud\Datastore\V1beta3\EntityResult_ResultType::class);
