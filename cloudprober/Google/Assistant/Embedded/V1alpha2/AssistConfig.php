...
class AssistConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.assistant.embedded.v1alpha2.ScreenOutConfig screen_out_config = 8;</code>
     */
    private $screen_out_config = null;
    /**
     ...
     *
     * Generated from protobuf field <code>.google.assistant.embedded.v1alpha2.DebugConfig debug_config = 5;</code>
     */
    private $debug_config = null;
    protected $type;
     ...
     *
     *     @type \Google\Assistant\Embedded\V1alpha2\AudioInConfig $audio_in_config
     ...
     *     @type \Google\Assistant\Embedded\V1alpha2\AudioOutConfig $audio_out_config
     *           *Required* Specifies how to format the audio that will be returned.
     *     @type \Google\Assistant\Embedded\V1alpha2\ScreenOutConfig $screen_out_config
     *           *Optional* Specifies the desired format to use when server returns a
     *           visual screen response.
     *     @type \Google\Assistant\Embedded\V1alpha2\DialogStateIn $dialog_state_in
     *           *Required* Represents the current dialog state.
     *     @type \Google\Assistant\Embedded\V1alpha2\DeviceConfig $device_config
     *           Device configuration that uniquely identifies a specific device.
     *     @type \Google\Assistant\Embedded\V1alpha2\DebugConfig $debug_config
     *           *Optional* Debugging parameters for the whole `Assist` RPC.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.assistant.embedded.v1alpha2.ScreenOutConfig screen_out_config = 8;</code>
     * @param \Google\Assistant\Embedded\V1alpha2\ScreenOutConfig $var
     * @return $this
     */
    public function setScreenOutConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Assistant\Embedded\V1alpha2\ScreenOutConfig::class);
        $this->screen_out_config = $var;
     ...
     *
     * Generated from protobuf field <code>.google.assistant.embedded.v1alpha2.DebugConfig debug_config = 5;</code>
     * @param \Google\Assistant\Embedded\V1alpha2\DebugConfig $var
     * @return $this
     */
    public function setDebugConfig($var)
    {
        GPBUtil::checkMessage($var, \Google\Assistant\Embedded\V1alpha2\DebugConfig::class);
        $this->debug_config = $var;
