 ...
 *
 * Protobuf type <code>google.assistant.embedded.v1alpha1.ConverseResponse.EventType</code>
 */
class EventType
{
    /**
...
class_alias(EventType::class, \Google\Assistant\Embedded\V1alpha1\ConverseResponse_EventType::class);
