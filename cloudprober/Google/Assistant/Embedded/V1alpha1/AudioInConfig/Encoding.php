 ...
 *
 * Protobuf type <code>google.assistant.embedded.v1alpha1.AudioInConfig.Encoding</code>
 */
class Encoding
{
    /**
...
class_alias(Encoding::class, \Google\Assistant\Embedded\V1alpha1\AudioInConfig_Encoding::class);
